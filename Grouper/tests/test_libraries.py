...
class TestLibrariesFragmentations(BaseTest):
    ...
    unifac_fail_molecules = [
        "C(=O)N", "OCC(=O)N(C)C", "C(=O)N(C)C", "CN", 
        "C[O-]", "CCC(=O)[O-]", "CCS(=O)(=O)[O-]", 
        "CCC#N", "C(=O)[N-]", "CO"
    ]
    ...
    groupsList = [
        ...
        {"HCOO":1}, {"CH3COO":1, "CH3":1}, {"CH2COO":1, "CH2":2, "OH (P)":1}, {"CONH2":1, "CH3":1}, {"CONHCH3":1, "CH3":1}, #carboxyl/amides
        {"CH3":1, "CH3NH":1}, {"CH2":1, "CH3NH":2},  # amines
        {"CF3":1}, {"CH2NH2":1, "CH2":2, "CF":1}, # fluorines
        {"CY-CH2":5, "CH3":1, "CY-CH":1}, {"CY-CH2":4, "CH3":2, "CY-CH":2}, # rings
        {"CY-CH2":4, "CH3":2, "CY-CH":2}, {"CY-CH2":4, "CH3":2, "CY-CH":2},# rings
        {"ACCH3":1, "ACH":2, "ACNO2":3}, {"ACH":5, "AC":1, "COOH":1}, # phenyl groups
        ]
    edgesList = [
        {("CH3","CH3"):1}, {("CH3","CH"):3}, {("CH3","CH2"):1, ("CH3","C"):3, ("CH2","C"):1}, {("C","CH3"):4}, # alkanes
        {("OH (P)", "CH2"):2, ("OH (S)", "CH"):1, ("CH2", "CH"):2}, # alcohols
        {}, {("CH3COO", "CH3"):1}, {("CH2COO", "CH2"):1, ("CH2", "CH2"):1, ("CH2", "OH (P)"):1}, {("CONH2",  "CH3"):1}, {("CONHCH3", "CH3"):1}, #carbxoyls/amides
        {("CH3", "CH3NH"):1}, {("CH2", "CH3NH"):2},  #amines
        {}, {("CH2NH2","CH2"):1,("CH2", "CF"):1, ("CH2", "CH2"):1}, # fluorines
        {("CY-CH2", "CY-CH2"):4, ("CH3", "CY-CH"):1, ("CY-CH2", "CY-CH"):2}, {("CY-CH2", "CY-CH2"):3, ("CH3", "CY-CH"):2, ("CY-CH2", "CY-CH"):2, ("CY-CH", "CY-CH"):1}, # rings
        {("CY-CH2", "CY-CH2"):2, ("CH3", "CY-CH"):2, ("CY-CH2", "CY-CH"):4},  {("CY-CH2", "CY-CH2"):2, ("CH3", "CY-CH"):2, ("CY-CH2", "CY-CH"):4},# rings
        {("ACCH3", "ACNO2"):2, ("ACNO2", "ACH"):4}, {("ACH", "ACH"):4, ("AC", "ACH"):2, ("AC", "COOH"):1}# phenyl groups
    ]
    ...
    def test_unifac_smiles(self, MOLSMILES, SITESDICT, EDGESDICT, unifac_groups):
        ...
        assert len(gGList) >= 1, print(fragment(MOLSMILES, unifac_groups, returnHandler="ideal", incompleteGraphHandler="keep", nodeDefsSorter="size"))
        firstgG = gGList[0]
