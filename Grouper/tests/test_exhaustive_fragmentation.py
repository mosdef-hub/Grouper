from Grouper import GroupGraph, Group, exhaustive_fragment
...
class TestGroupGraph(BaseTest):
    def test_fragment(self):
        ...
        out = exhaustive_fragment(smiles, node_defs)
    ...
    def test_invalid_smiles(self):
        ...
        try:
            exhaustive_fragment(smiles, node_defs)
    ...
    def test_triple_node(self):
        ...
        out = exhaustive_fragment("O=COOC(=O)O", node_defs)
        ...
        out = exhaustive_fragment("CNCNOC=O", node_defs)
        ...
        out = exhaustive_fragment("CNO", node_defs)
        ...
        out = exhaustive_fragment("O=C(O)OO", node_defs)
    ...
    def test_nodes_made_of_other_nodes(self):
        ...
        out = exhaustive_fragment("CCC(C)NCCNC", node_defs)
    ...
    def test_other_edge_cases(self):
        ...
        out = exhaustive_fragment("CCC", node_defs)
