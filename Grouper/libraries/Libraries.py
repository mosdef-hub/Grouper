...
class Joback(BasisSet):
    ...
    def __init__(self):
        ...
        self.group_traces = [
            ...
            GroupExtension(Group('>CH-', '[CX4H;!R]', [0,0,0], 'SMARTS'), self.doi, 'C', None),
            GroupExtension(Group('>C<', '[CX4H0;!R]', [0,0,0,0], 'SMARTS'), self.doi, 'C', None),
            ...
            GroupExtension(Group('=C<', '[$([#6X3H0;!R]);!$([#6X3H0;!R]=[#8])]', [0,0,0], 'SMARTS'), self.doi, 'C', None),
...
class SaftGammaMie(BasisSet):
    ...
    def __init__(self):
        ...
        self.group_traces = [
            ...
            GroupExtension(Group('CH=', '[CX3H1;!R;!$([CX3H1](=O))]', [0,0], 'SMARTS'), self.doi, 'C', None),
            ...
            GroupExtension(Group('N', '[#7X3H0;!$([#7](~O)~O);!R]', [0,0,0], 'SMARTS'), self.doi, 'N', None),
            GroupExtension(Group('cNH', '[#7X3H1;R]', [0,0], 'SMARTS'), self.doi, 'N', None),
            GroupExtension(Group('cN', '[#7X3H0;R]', [0,0,0], 'SMARTS'), self.doi, 'N', None),
            GroupExtension(Group('C=', '[CX3H0;!R;!$([CX3H0](=O))]', [0,0,0], 'SMARTS'), self.doi, 'C', None),
