...
class Joback(BasisSet):
    ...
    def __init__(self):
        ...
        self.node_traces = [
            ...
            GroupExtension(Group("-CH=CH-", "C=C", [0, 1]), doi, "[CX3H1][CX3H1]", None),
            GroupExtension(
                Group("=C<", "C", [0, 0, 0]),
                doi,
                "[$([!R;#6X3H0]);!$([!R;#6X3H0]=[#8])]",
            ...
            GroupExtension(Group("ring=CH-", "C", [0, 0]), doi, "[R;CX3H1,cX3H1]", None),
            GroupExtension(
...
class Unifac(BasisSet):
    ...
    def __init__(self):
        ...
        self.node_traces = [
            GroupExtension(Group("CH3", "[CX4;H3;!R]", [0], "SMARTS"), doi, "[CX4;H3;!R]", None),
            GroupExtension(Group("CH2", "[CX4;H2;!R]", [0, 0], "SMARTS"), doi, "[CX4;H2;!R]", None),
            GroupExtension(Group("CH", "[CX4;H1;!R]", [0, 0, 0], "SMARTS"), doi, "[CX4;H1;!R]", None),
            GroupExtension(Group("C", "[CX4;H0;!R]", [0, 0, 0, 0], "SMARTS"), doi, "[CX4;H0;!R]", None),
            GroupExtension(Group("CH2=CH", "C=C", [0], "SMARTS"), doi, "[CX3;H2]=[CX3;H1]", None),
            GroupExtension(
                Group("CH=CH", "C=C", [0, 1]), doi, "[CX3;H1]=[CX3;H1]", None
            ),
            GroupExtension(
                Group("CH2=C", "C=C", [0, 0]), doi, "[CX3;H2]=[CX3;H0]", None
            ),
            GroupExtension(
                Group("CH=C", "C=C", [0, 0, 1]), doi, "[CX3;H1]=[CX3;H0]", None
            ),
            GroupExtension(
                Group("OH (P)", "O", [0]), doi, "[OH1;$([OH1][CX4H2])]", None
            ),
            GroupExtension(Group("CH3OH", "CO", [0]), doi, "[CX4;H3][OX2;H1]", None),
            GroupExtension(
                Group("ACOH", "C=O", [0, 0]), doi, "[cX3;H0;R][OX2;H1]", None
            ),
            GroupExtension(
                Group("CH2CO", "CC=O", [0]), doi, "[CX4;H2][CX3;!H1](=O)", None
            ),
            GroupExtension(Group("CHO", "C=O", [0, 0]), doi, "[CX3H1](=O)", None),
            GroupExtension(
                Group("CH3COO", "CC(=O)O", [3]), doi, "[CH3][CX3;H0](=[O])[OH0]", None
            ),
            GroupExtension(
            ...
            GroupExtension(
                Group("HCOO", "C(=O)O", [0, 2]), doi, "[CX3;H1](=[OX1])[OX2]", None
            ),
            GroupExtension(Group("CH3O", "CO", [0, 1]), doi, "[CH3;!R][OH0;!R]", None),
            GroupExtension(Group("CH2O", "CO", [0, 1]), doi, "[CH2;!R][OH0;!R]", None),
            GroupExtension(Group("CHO", "CO", [0, 1]), doi, "[C;H1;!R][OH0;!R]", None),
            GroupExtension(Group("ACH", "C=O", [0]), doi, "[cX3;H1]", None),
            GroupExtension(Group("AC", "C=O", [0]), doi, "[cX3;H0]", None),
            GroupExtension(Group("ACCH3", "C(=O)C", [0]), doi, "[cX3;H0][CX4;H3]", None),
            GroupExtension(
                Group("ACCH2", "C(=O)C", [0, 2]), doi, "[cX3;H0][CX4;H2]", None
            ),
            GroupExtension(
                Group("ACCH", "C(=O)C", [0, 2, 2]), doi, "[cX3;H0][CX4;H1]", None
            ),
            GroupExtension(Group("CH2NH2", "CN", [0]), doi, "[CX4;H2][NX3;H2]", None),
            GroupExtension(Group("CHNH2", "CN", [0, 0]), doi, "[CX4;H1][NX3;H2]", None),
            GroupExtension(Group("CH3NH", "CN", [1]), doi, "[CX4;H3][NX3;H1]", None),
            GroupExtension(Group("CH2NH", "CN", [0, 1]), doi, "[CX4;H2][NX3;H1]", None),
            GroupExtension(
                Group("CHNH", "CN", [0, 0, 1]), doi, "[CX4;H1][NX3;H1]", None
            ),
            GroupExtension(Group("CH3N", "CN", [1, 1]), doi, "[CX4;H3][NX3;H0]", None),
            GroupExtension(
                Group("CH2N", "CN", [0, 1, 1]), doi, "[CX4;H2][NX3;H0]", None
            ),
            GroupExtension(Group("ACNH2", "C(=O)N", [0]), doi, "[c][NX3;H2]", None),
            GroupExtension(
                Group("AC2H2N", "C(=O)NC=O", [2]), doi, "[cX3H1][n][cX3H1]", None
            ),
            GroupExtension(
                Group("AC2HN", "C(=O)NC=O", [0, 2]), doi, "[cX3H0][n][cX3H1]", None
            ),
            GroupExtension(
                Group("AC2N", "C(=O)NC=O", [0, 2, 3]), doi, "[cX3H0][n][cX3H0]", None
            ),
            GroupExtension(
                Group("CH2CN", "CC#N", [0]), doi, "[CX4;H2][CX2]#[NX1]", None
            ),
            GroupExtension(
                Group("COO", "C(=O)O", [0, 1]),
                doi,
            ...
            GroupExtension(
                Group("COOH", "C(=O)O", [0]), doi, "[CX3](=[OX1])[O;H1]", None
            ),
            GroupExtension(
            ...
            GroupExtension(
                Group("CCL", "C([Cl])", [0, 0, 0], "SMARTS"), doi, "[CX4;H0](Cl)", None
            ),
            GroupExtension(
                Group("CH2CL", "C([Cl])", [0], "SMARTS"),
                doi,
            ...
            GroupExtension(
                Group("ACCL", "C(=O)([Cl])", [0], "SMARTS"), doi, "[c][Cl]", None
            ),
            GroupExtension(
            ...
            GroupExtension(Group("CH2SH", "CS", [0]), doi, "[SX2H][CX4;H2]", None),
            GroupExtension(Group("I", "I", [0]), doi, "[I]", None),
            GroupExtension(Group("BR", "[Br]", [0], "SMARTS"), doi, "[Br]", None),
            GroupExtension(Group("CH=-C", "C#C", [0]), doi, "[CX2;H1]#[CX2;H0]", None),
            GroupExtension(Group("C=-C", "C#C", [0, 1]), doi, "[CX2;H0]#[CX2;H0]", None),
            GroupExtension(
            ...
            GroupExtension(
                Group("C=C", "C=C", [0, 0, 1, 1]), doi, "[CX3;H0]=[CX3;H0]", None
            ),
            GroupExtension(Group("ACF", "C(=O)F", [0]), doi, "[cX3][F]", None),
            GroupExtension(Group("CF3", "C(F)(F)F", [0]), doi, "C(F)(F)F", None),
            GroupExtension(Group("CF2", "C(F)F", [0, 0]), doi, "C(F)F", None),
            GroupExtension(Group("CF", "CF", [0, 0, 0]), doi, "C(F)", None),
            GroupExtension(Group("CY-CH2", "C", [0, 0]), doi, "[CH2;R]", None),
            GroupExtension(Group("CY-CH", "C", [0, 0, 0]), doi, "[CH1;R]", None),
            GroupExtension(Group("CY-C", "C", [0, 0, 0, 0]), doi, "[CH0;R]", None),
            GroupExtension(
                Group("OH (S)", "CO", [0, 0]), doi, "[OH1;$([OH1][CX4H1])]", None
            ),
            GroupExtension(
                Group("OH (T)", "CO", [0, 0, 0]), doi, "[OH1;$([OH1][CX4H0])]", None
            ),
            GroupExtension(
            ...
            GroupExtension(Group("CNH2", "CN", [0, 0, 0]), doi, "[CX4H0][NH2]", None),
            GroupExtension(
                Group("CONH2", "C(=O)N", [0]), doi, "[CX3H0](=[OX1H0])[NX3H2]", None
            ),
            GroupExtension(
