...
GroupExtension = namedtuple("GroupExtension", ["node", "doi", "extended_smarts", "priority"])
...
class Joback(BasisSet):
    ...
    def __init__(self):
        ...
        self.node_traces = [
            ...
            GroupExtension(Group("-OH (phenol)", "O", [0]), "", "[O;H1;$(O-!@c)]", None),
            GroupExtension(
            ...
            GroupExtension(Group("O=CH- (aldehyde)", "O=C", [1]), "", "[CH;D2](=O)", None),
            GroupExtension(Group("-COOH (acid)", "C(=O)O", [0]), "", "[OX2H]-[C]=O", None),
            GroupExtension(
            ...
            GroupExtension(Group(">NH (non-ring)", "N", [0, 0]), "", "[NX3H1;!R]", None),
            ...
            GroupExtension(Group("-N= (non-ring)", "N", [0, 0]), "", "[#7X2H0;!R]", None),
            ...
            GroupExtension(Group("-S- (non-ring)", "S", [0, 0]), "", "[#16X2H0;!R]", None),
...
class Unifac(BasisSet):
    ...
    def __init__(self):
        ...
        self.node_traces = [
            ...
            GroupExtension(Group('CH=CH', 'C=C', [0,1]), '', '[CX3;H1]=[CX3;H1]', None),
            GroupExtension(Group('CH2=C', 'C=C', [0,0]), '', '[CX3;H2]=[CX3;H0]', None),
            GroupExtension(Group('CH=C', 'C=C', [0,0,1]), '', '[CX3;H1]=[CX3;H0]', None),
            GroupExtension(Group('OH (P)', 'O', [0]), '', '[OH1;$([OH1][CX4H2])]', None),
            GroupExtension(Group('CH3OH', 'CO', [0]), '', '[CX4;H3][OX2;H1]', None),
            GroupExtension(Group('ACOH', 'C=O', [0,0]), '', '[cX3;H0;R][OX2;H1]', None),
            GroupExtension(Group('CH2CO', 'CC=O', [0]), '', '[CX4;H2][CX3;!H1](=O)', None),
            GroupExtension(Group('CHO', 'C=O', [0,0]), '', '[CX3H1](=O)', None),
            GroupExtension(Group('CH3COO', 'CC(=O)O', [3]), '', '[CH3][CX3;H0](=[O])[OH0]', None),
            GroupExtension(Group('CH2COO', 'CC(=O)O', [0,3]), '', '[CX4;H2][CX3](=[OX1])[OX2]', None),
            GroupExtension(Group('HCOO', 'C(=O)O', [0,2]), '', '[CX3;H1](=[OX1])[OX2]', None),
            ...
            GroupExtension(Group('ACCH2', 'C(=O)C', [0,2]), '', '[cX3;H0][CX4;H2]', None),
            GroupExtension(Group('ACCH', 'C(=O)C', [0,2,2]), '', '[cX3;H0][CX4;H1]', None),
            ...
            GroupExtension(Group('CHNH', 'CN', [0,0,1]), '', '[CX4;H1][NX3;H1]', None),
            GroupExtension(Group('CH3N', 'CN', [1,1]), '', '[CX4;H3][NX3;H0]', None),
            GroupExtension(Group('CH2N', 'CN', [0,1,1]), '', '[CX4;H2][NX3;H0]', None),
            GroupExtension(Group('ACNH2', 'C(=O)N', [0]), '', '[c][NX3;H2]', None),
            GroupExtension(Group('AC2H2N', 'C(=O)NC=O', [2]), '', '[cX3H1][n][cX3H1]', None),
            GroupExtension(Group('AC2HN', 'C(=O)NC=O', [0,2]), '', '[cX3H0][n][cX3H1]', None),
            GroupExtension(Group('AC2N', 'C(=O)NC=O', [0,2,3]), '', '[cX3H0][n][cX3H0]', None),
            GroupExtension(Group('CH2CN', 'CC#N', [0]), '', '[CX4;H2][CX2]#[NX1]', None),
            GroupExtension(Group('COO', 'C(=O)O', [0,1]), '', '[CX3,cX3](=[OX1])[OX2H0,oX2H0]', None),
            GroupExtension(Group('COOH', 'C(=O)O', [0]), '', '[CX3](=[OX1])[O;H1]', None),
            GroupExtension(Group('CH2CL', 'C([Cl])', [0], True), '', '[CX4;H2;!$(C(Cl)(Cl))](Cl)', None),
            GroupExtension(Group('CHCL', 'C([Cl])', [0,0], True), '', '[CX4;H1;!$(C(Cl)(Cl))](Cl)', None),
            GroupExtension(Group('CCL', 'C([Cl])', [0,0,0], True), '', '[CX4;H0](Cl)', None),
            GroupExtension(Group('CH2CL', 'C([Cl])', [0], True), '', '[CX4;H2;!$(C(Cl)(Cl))](Cl)', None),
            GroupExtension(Group('CHCL', 'C([Cl])', [0,0], True), '', '[CX4;H1;!$(C(Cl)(Cl))](Cl)', None),
            GroupExtension(Group('CCL', 'C([Cl])', [0,0,0], True), '', '[CX4;H0](Cl)', None),
            GroupExtension(Group('CHCL2', 'C([Cl])([Cl])', [0], True), '', '[CX4;H1;!$(C(Cl)(Cl)(Cl))](Cl)(Cl)', None),
            GroupExtension(Group('CCL2', 'C([Cl])([Cl])', [0,0], True), '', '[CX4;H0;!$(C(Cl)(Cl)(Cl))](Cl)(Cl)', None),
            GroupExtension(Group('CCL3', 'C([Cl])([Cl])([Cl])', [0], True), '', '[CX4;H0;!$([CX4;H0](Cl)(Cl)(Cl)(Cl))](Cl)(Cl)(Cl)', None),
            GroupExtension(Group('ACCL', 'C(=O)([Cl])', [0], True), '', '[c][Cl]', None),
            GroupExtension(Group('CH2NO2', 'C[N+](=O)[O-]', [0], True), '', '[CX4;H2][NX3](=[OX1])([OX1])', None),
            GroupExtension(Group('CHNO2', 'C[N+](=O)[O-]', [0,0], True), '', '[CX4;H1][NX3](=[OX1])([OX1])', None),
            GroupExtension(Group('ACNO2', 'C(=O)[N+](=O)[O-]', [0], True), '', '[cX3][NX3](=[OX1])([OX1])', None),
            ...
            GroupExtension(Group('CL-(C=C)', '[Cl][C]=[C]', [1,2,2], True), '', '[$([Cl;H0]([C]=[C]))]', None),
            GroupExtension(Group('C=C', 'C=C', [0,0,1,1]), '', '[CX3;H0]=[CX3;H0]', None),
            ...
            GroupExtension(Group('OH (S)', 'CO', [0,0]), '', '[OH1;$([OH1][CX4H1])]', None),
            GroupExtension(Group('OH (T)', 'CO', [0,0,0]), '', '[OH1;$([OH1][CX4H0])]', None),
            GroupExtension(Group('CY-CH2O', 'CO', [0,1]), '', '[CX4H2;R][OX2;R;$(O(CC)C)][CX4H2;R][OX2;R][CX4H2;R]', None),
            GroupExtension(Group('CNH2', 'CN', [0,0,0]), '', '[CX4H0][NH2]', None),
            GroupExtension(Group('CONH2', 'C(=O)N', [0]), '', '[CX3H0](=[OX1H0])[NX3H2]', None),
            GroupExtension(Group('CONHCH3', 'C(=O)NC', [0]), '', '[OX1H0;!R]=[CX3H0;!R][NH1X3;!R][CH3;!R]', None),
